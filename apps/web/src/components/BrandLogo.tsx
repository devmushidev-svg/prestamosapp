...
/**
 * Isotipo MultiPréstamos (punto + líneas “flujo”). Misma geometría que /favicon.svg y /brand-logo.svg.
  ...
  return (
    <span className={`inline-flex items-center gap-2.5 min-w-0 ${className}`.trim()}>
      ...
      <span className="flex min-w-0 flex-col leading-tight">
        <span className="truncate text-[15px] font-bold tracking-tight text-white">MultiPréstamos</span>
        {showTagline ? (
